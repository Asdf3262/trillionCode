...
<style>
  ...
  input, select {
    ...
    border-radius: 50px;
    border-top: 2px solid rgb(48,54,68);
    border-right: 2px solid rgb(48,54,68);
    padding: 15px;
    padding-left: 20px;
    padding-right: 20px;
    font-size: 16px;
  ...
  .row div:nth-child(2) input, select {
    border: 8px solid rgb(48,54,68);
    border-bottom: 2px solid rgb(48,54,68);
    border-left: 2px solid rgb(48,54,68);
  }
  .check label{
    max-width: 700px;
    font-size: 12px;
